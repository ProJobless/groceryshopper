...
@section('breadcrumb')
	 ...
	 <a href="{{{ URL::to('admin/permissions/' .$permission->id . '/edit') }}}" title="{{{ $title }}}" class="tip-bottom"><i class="fa fa-edit"></i>{{{ $title }}}</a>
...
@section('formcontent')
	...
	<form class="form-horizontal" method="post" action="" autocomplete="off">
		...
		<div class="form-group {{{ $errors->has('name') ? 'error' : '' }}}">
			...
			<div class="col-md-10">
				<input class="form-control" type="text" name="name" id="name" value="{{{ Input::old('name', $permission->name) }}}" />
		...
		<div class="form-group {{{ $errors->has('display_name') ? 'error' : '' }}}">
			...
			<div class="col-md-10">
				<input class="form-control" type="text" name="display_name" id="display_name" value="{{{ Input::old('display_name', $permission->display_name) }}}" />
